const rechargeHistory = [
    { id: "TXN123", date: "2025-02-15", time: "14:30", plan: "Basic Plan", amount: 10, status: "Success", gst: 1.8, discount: 0, validity: 28, expiryDate: "2025-03-15", dataLimit: 1.5, dataUnit: "GB/Day" },
    { id: "TXN124", date: "2025-02-14", time: "09:45", plan: "Premium Plan", amount: 20, status: "Success", gst: 3.6, discount: 2, validity: 56, expiryDate: "2025-04-11", dataLimit: 2, dataUnit: "GB/Day" }
];
...
function generateInvoice(txnId) {
    ...
    doc.setFontSize(12);
    doc.text("RechargeFlow", 20, 40);
    doc.text("123 Street Name", 20, 45);
    doc.text("Salem, International", 20, 50);
    doc.text("Phone: +91 1234567890", 20, 55);
    ...
    doc.text(`${txn.plan} (${txn.dataLimit} ${txn.dataUnit}/Day, Validity: ${txn.validity} Days, Expiry: ${txn.expiryDate})`, 22, 110);
    ...
    doc.setFontSize(10);
    doc.text("Thank you for choosing RechargeFlow!", 105, yPos + 50, { align: "center" });
    doc.text("For customer support, please call +91 1234567890 or email support@rechargeflow.com", 105, yPos + 55, { align: "center" });
